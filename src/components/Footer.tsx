...
import { Leaf, Facebook, Instagram, Send, Youtube } from 'lucide-react';
...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      icon: Instagram,
      href: 'https://www.instagram.com/oolong_teauz',
      label: 'Instagram',
    },
    {
      icon: Send,
      href: 'https://t.me/OolongTeaNamangan',
      label: 'Telegram',
    },
  ];
